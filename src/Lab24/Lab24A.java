...
// Only one bean found with matching type B
public class Lab24A {
	...
	//	ApplicationContext ctx = new ClassPathXmlApplicationContext(); // It will find the bean configuration XML file which default name "applicationContext.xml"
		ApplicationContext ctx = new ClassPathXmlApplicationContext("/Lab24/myBeanFile.xml"); // to lead our own custom defined bean configuration XML file
