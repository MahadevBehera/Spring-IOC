...
// Bean Loading Example Using XML Based Configuration (Spring IOC)
public class Lab5A {
	...
	//	ApplicationContext ctx = new ClassPathXmlApplicationContext(); // It will find the bean configuration XML file which default name "applicationContext.xml"
		ApplicationContext ctx = new ClassPathXmlApplicationContext("/Lab5/myBeanFile.xml"); // to lead our own custom defined bean configuration XML file
